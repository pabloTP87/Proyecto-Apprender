...
class LeccionSilabasTwoActivity : AppCompatActivity(), ILeccionVocalesOne, SilabasTwoConfirmFragment.sendTimeChronometer {
    ...
    override fun datosLeccionOne(puntaje: Int, acierto: Boolean) {
        ...
        val fragment = MarSilabasTwoFragment()
    ...
    override fun datosLeccionTwo(puntaje: Int, acierto: Boolean) {
        ...
        val fragment = MarSilabasThreeFragment()
    ...
    override fun datosLeccionThree(puntaje: Int, acierto: Boolean) {
        ...
        val fragment = SilabasTwoConfirmFragment()
    ...
    private fun createFragment(fragment: Fragment){
        ...
        transaction.replace(R.id.leccion_slbs_two_container,fragment)
