...
class MarSilabasTwoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mar_silabas_two, container, false)

        layout = R.id.mar_silabas_two_layout
        ...
        rgOptions.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.sil_1 -> {
                    ...
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@MarSilabasTwoFragment.context!!,R.color.btn_green_selector_unpressed)
                }
                R.id.sil_2 -> {
                    btnVerificar.isEnabled = true
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@MarSilabasTwoFragment.context!!,R.color.btn_green_selector_unpressed)
