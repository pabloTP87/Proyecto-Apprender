...
class LeccionImgAFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_leccion_img_a, container, false)
        layout = R.id.leccion_img_a_layout
        ...
        rgOptions.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.a -> {
                    ...
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@LeccionImgAFragment.context!!,R.color.btn_green_selector_unpressed)
                }
                R.id.e -> {
                    btnVerificar.isEnabled = true
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@LeccionImgAFragment.context!!,R.color.btn_green_selector_unpressed)
