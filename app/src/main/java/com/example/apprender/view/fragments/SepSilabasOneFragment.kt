        ...
        input.addTextChangedListener(object: TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (text.isNotEmpty()){
                    ...
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@SepSilabasOneFragment.context!!,R.color.btn_green_selector_unpressed)
                    ...
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@SepSilabasOneFragment.context!!,R.color.btn_disable_grey)
                }
            }
        })
