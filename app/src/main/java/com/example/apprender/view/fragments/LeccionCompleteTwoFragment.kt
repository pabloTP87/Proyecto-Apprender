...
class LeccionCompleteTwoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_leccion_complete_two, container, false)
        ...
        layout = R.id.leccion_complete_two_layout
        ...
        val textWatcher = object: TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (inputU.text.isNotEmpty() && inputA.text.isNotEmpty()){
                    ...
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@LeccionCompleteTwoFragment.context!!,R.color.btn_green_selector_unpressed)
                }
            }
        ...
        btnVerificar.setOnClickListener {
            ...
            if (vocalOne.equals("a") && vocalTwo.equals("a")) {
