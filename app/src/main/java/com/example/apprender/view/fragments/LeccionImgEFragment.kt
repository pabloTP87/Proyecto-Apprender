...
class LeccionImgEFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_leccion_img_e, container, false)
        layout = R.id.leccion_img_e_layout
        ...
        rgOptions.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.a -> {
                    ...
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@LeccionImgEFragment.context!!,R.color.btn_green_selector_unpressed)
                }
                R.id.e -> {
                    btnVerificar.isEnabled = true
                    btnVerificar.backgroundTintList = ContextCompat.getColorStateList(this@LeccionImgEFragment.context!!,R.color.btn_green_selector_unpressed)
