...
class LecturaPalabrasOneFragment : Fragment() {

    private lateinit var iPalabrasOne : ILeccionVocalesOne
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_lectura_palabras_one, container, false)

        layout = R.id.lectura_palabras_one_layout
        val mLayoutInflater = layoutInflater

        val btnMic = view.findViewById<Button>(R.id.btn_mic_lect_pal_one)
        val btnCheck = view.findViewById<Button>(R.id.btnVerificar)
        val input = view.findViewById<EditText>(R.id.txt_lect_pal_one)
        ...
        input.addTextChangedListener(object: TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (text.isNotEmpty()){
                    ...
                    btnCheck.backgroundTintList = ContextCompat.getColorStateList(this@LecturaPalabrasOneFragment.context!!,R.color.btn_green_selector_unpressed)
                    btnMic.backgroundTintList = ContextCompat.getColorStateList(this@LecturaPalabrasOneFragment.context!!,R.color.btn_mic_primary_dark_selector_unpressed)
                }else{
                    btnCheck.isEnabled = false
                    btnCheck.backgroundTintList = ContextCompat.getColorStateList(this@LecturaPalabrasOneFragment.context!!,R.color.btn_disable_grey)
                }
            }
        })
        ...
        btnCheck.setOnClickListener {
            ...
            if (matchInput(silabaOne)){
                ...
                if (silabaOne.equals("meta")){

                    val puntaje = 5
                    val acierto = true
                    iPalabrasOne.datosLeccionOne(puntaje, acierto)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        iPalabrasOne = activity as ILeccionVocalesOne
    }
