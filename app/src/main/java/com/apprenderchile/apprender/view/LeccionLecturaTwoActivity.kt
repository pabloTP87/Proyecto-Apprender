...
class LeccionLecturaTwoActivity : AppCompatActivity(), ILeccionVocalesOne, LecturaTwoConfirmFragment.sendTimeChronometer {
    ...
    override fun stopTimer() {
        val fragment = LecturaTwoConfirmFragment()
        chronometer.stop()
    ...
    override fun datosLeccionOne(puntaje: Int, acierto: Boolean) {
        val fragment = LecturaOracionesTwoFragment()
    ...
    override fun datosLeccionTwo(puntaje: Int, acierto: Boolean) {
        val fragment = LecturaOracionesThreeFragment()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_leccion_lectura_two)
    ...
    private fun createInitFragment(){
        ...
        val fragment = LecturaOracionesOneFragment()
        transaction.replace(R.id.leccion_lctr_two_container,fragment)
        transaction.commit()
    }
