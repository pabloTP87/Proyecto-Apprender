...
class LecturaOracionesTwoFragment : Fragment() {

    private lateinit var iOracionesTwo : ILeccionVocalesOne
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_lectura_oraciones_two, container, false)

        layout = R.id.lectura_oraciones_two_layout
        val mLayoutInflater = layoutInflater

        val btnMic = view.findViewById<Button>(R.id.btn_mic_lect_ora_two)
        val btnCheck = view.findViewById<Button>(R.id.btnVerificar)
        val input = view.findViewById<EditText>(R.id.txt_lect_ora_two)
        ...
        input.addTextChangedListener(object: TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (text.isNotEmpty()){
                    ...
                    btnCheck.backgroundTintList = ContextCompat.getColorStateList(this@LecturaOracionesTwoFragment.context!!,R.color.btn_green_selector_unpressed)
                    btnMic.backgroundTintList = ContextCompat.getColorStateList(this@LecturaOracionesTwoFragment.context!!,R.color.btn_mic_primary_dark_selector_unpressed)
                }else{
                    btnCheck.isEnabled = false
                    btnCheck.backgroundTintList = ContextCompat.getColorStateList(this@LecturaOracionesTwoFragment.context!!,R.color.btn_disable_grey)
                }
            }
        })
        ...
        btnCheck.setOnClickListener {
            ...
            if (matchInput(silabaOne)){
                ...
                if (silabaOne.equals("mi tía ama a mi tío")){

                    val puntaje = 5
                    val acierto = true
                    iOracionesTwo.datosLeccionTwo(puntaje, acierto)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        iOracionesTwo = activity as ILeccionVocalesOne
    }
